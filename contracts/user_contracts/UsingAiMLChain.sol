...
/**
* @dev Contract to be extended to get the AiMLChain functionalties.
* This has functions to make relevant request calls to the proxy,
* and receive predictions.
*/
contract UsingAiMLChain {
  ...
  event AiMLChainContractChanged(address newAddress);
  ...
  */
  ...
  /**
  * @dev callback function to allow AiMLChain serve the requested prediction 
